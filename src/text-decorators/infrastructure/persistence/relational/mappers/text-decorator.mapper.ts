...
export class TextDecoratorMapper {
  static toDomain(raw: TextDecoratorEntity): TextDecorator {
    const domainEntity = new TextDecorator();
  ...
  static toPersistence(domainEntity: TextDecorator): TextDecoratorEntity {
    const persistenceEntity = new TextDecoratorEntity();
